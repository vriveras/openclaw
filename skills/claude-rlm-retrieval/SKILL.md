...
This skill makes Claude Code _actually usable across long sessions and compaction_ by treating Claude’s own transcripts as the source of truth and adding:
...
- use `/rlm-get` as the _canonical_ retrieval entrypoint
