...
def enhanced_keyword_match(
    ...
    max_content_words: int = 2000  # Reduced from 5000 for performance
) -> Tuple[bool, List[str]]:
    """
    ...
    for qword in expanded_query:
        ...
        if use_substring:
            for cword in content_words_list[:1000]:  # Reduced from 2000 for performance
                ...
                if use_fuzzy:
                    for cword in content_words_list[:500]:  # Reduced from 1000 for performance
